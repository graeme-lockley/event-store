...
import com.eventstore.application.usecases.GetEventsUseCase
import com.eventstore.application.usecases.PublishEventsUseCase
...
fun Route.eventRoutes(
    publishEventsUseCase: PublishEventsUseCase,
        ...
        post {
            try {
                ...
                val eventRequests = requests.map { dto ->
                    com.eventstore.application.usecases.EventRequest(
                        topic = dto.topic,
                        type = dto.type,
                        payload = dto.payload
                    )
                ...
                val eventIds = publishEventsUseCase.execute(eventRequests)
    ...
    route("/topics/{topic}/events") {
        ...
        get {
            try {
                ...
                val events = getEventsUseCase.execute(topic, sinceEventId, date, limit)
