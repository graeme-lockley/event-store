...
import com.eventstore.application.usecases.CreateTopicUseCase
import com.eventstore.application.usecases.GetTopicsUseCase
import com.eventstore.application.usecases.UpdateTopicSchemasUseCase
...
fun Route.topicRoutes(
    ...
    updateTopicSchemasUseCase: UpdateTopicSchemasUseCase,
    ...
    route("/topics") {
        ...
        post {
            try {
                ...
                createTopicUseCase.execute(request.name, schemas)
        ...
        get("{topic}") {
            try {
                ...
                val topic = getTopicsUseCase.execute(topicName)
        ...
        put("{topic}") {
            try {
                ...
                updateTopicSchemasUseCase.execute(topicName, schemas)
