...
- [x] Each event has tenant and namespace fields but then, in the ID, these same fields are present.  These fields should be removed from the event and the ID should contain the full qualified identity.
- [x] Remove the multi-tenant option; currently this is stored in the Config.
