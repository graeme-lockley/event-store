...
fun Application.configureApplication(config: Config) {
    ...
    println("     GET    /tenants/{tenantName}/namespaces - List namespaces in tenant")
    ...
    println("     PUT    /tenants/{tenantName}/namespaces/{namespaceName}/topics/{topic} - Update topic schemas")
