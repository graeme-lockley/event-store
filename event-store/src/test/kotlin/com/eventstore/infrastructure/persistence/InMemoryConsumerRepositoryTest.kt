...
class InMemoryConsumerRepositoryTest {
    ...
    @Test
    fun `should save and find consumer`() =
        runTest {
    ...
    @Test
    fun `should return null when consumer not found`() =
        runTest {
    ...
    @Test
    fun `should find consumers by topic`() =
        runTest {
    ...
    @Test
    fun `should return false when deleting non-existent consumer`() =
        runTest {
