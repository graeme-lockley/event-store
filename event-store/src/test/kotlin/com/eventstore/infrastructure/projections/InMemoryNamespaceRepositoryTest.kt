...
class InMemoryNamespaceRepositoryTest {
    ...
    @Test
    fun `save creates namespace in all indexes`() =
        runTest {
    ...
    @Test
    fun `findById returns namespace by tenantId and namespaceId`() =
        runTest {
            val tenantId = UUID.randomUUID()
            val namespaceId = UUID.randomUUID()
            val namespace =
    ...
    @Test
    fun `findById returns namespace by namespaceId only`() =
        runTest {
            val tenantId = UUID.randomUUID()
            val namespaceId = UUID.randomUUID()
            val namespace =
    ...
    @Test
    fun `findById returns null when namespace not found`() =
        runTest {
    ...
    @Test
    fun `findByName returns namespace by tenant and namespace name`() =
        runTest {
            val tenantId = UUID.randomUUID()
            val namespaceId = UUID.randomUUID()
            val namespace =
    ...
    @Test
    fun `save updates existing namespace and maintains index consistency`() =
        runTest {
            val tenantId = UUID.randomUUID()
            val namespaceId = UUID.randomUUID()
            val original =
    ...
    @Test
    fun `findAll returns all saved namespaces`() =
        runTest {
