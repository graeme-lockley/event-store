...
class GetTenantServiceTest {
    ...
    @Test
    fun `returns null when tenant does not exist`() =
        runTest {
    ...
    @Test
    fun `returns null when tenant is deleted`() =
        runTest {
    ...
    @Test
    fun `lists bootstrap tenant when no custom tenants exist`() =
        runTest {
            val tenants = application.listTenants()
    ...
    @Test
    fun `gets bootstrap system tenant`() =
        runTest {
    ...
    @Test
    fun `lists single custom tenant`() =
        runTest {
    ...
    @Test
    fun `list tenants excludes deleted tenants`() =
        runTest {
            val initialCount = getInitialTenantCount()
    ...
    @Test
    fun `gets tenant with quota and metadata`() =
        runTest {
            val quota =
                Quota(
                    maxTopics = 10,
    ...
    @Test
    fun `gets tenant preserves resourceId after update`() =
        runTest {
    ...
    @Test
    fun `gets tenant returns null for updated name when original name is used`() =
        runTest {
    ...
    @Test
    fun `list tenants excludes multiple deleted tenants`() =
        runTest {
            val initialCount = getInitialTenantCount()
    ...
    @Test
    fun `list tenants returns all tenant fields correctly`() =
        runTest {
            val quota =
                Quota(
                    maxTopics = 15,
    ...
    @Test
    fun `gets tenant is case sensitive`() =
        runTest {
    ...
    @Test
    fun `getTenantByName retrieves tenant by name`() =
        runTest {
    ...
    @Test
    fun `getTenantByName returns null when tenant does not exist`() =
        runTest {
    ...
    @Test
    fun `getTenant retrieves tenant by UUID`() =
        runTest {
    ...
    @Test
    fun `getTenant returns null when tenant ID does not exist`() =
        runTest {
    ...
    @Test
    fun `getTenant returns null when tenant is deleted`() =
        runTest {
    ...
    @Test
    fun `getTenantByName returns null when tenant is deleted`() =
        runTest {
    ...
    @Test
    fun `getTenant and getTenantByName return same tenant for active tenant`() =
        runTest {
    ...
    @Test
    fun `getTenant works after tenant name is updated`() =
        runTest {
