...
class UpdateNamespaceServiceTest {
    ...
    @Test
    fun `updates namespace and emits event`() =
        runTest {
    ...
    @Test
    fun `throws when namespace does not exist`() =
        runTest {
    ...
    @Test
    fun `updates namespace name only`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `updates namespace description only`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `updates namespace metadata only`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `event is stored with correct tenant and namespace context`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `event sequence is correctly incremented`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `event timestamp is set correctly`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `event payload matches NamespaceUpdatedEvent structure`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `updates namespace with unicode characters in name`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `can update namespace multiple times sequentially`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `event namespaceId matches original namespace namespaceId`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `updatedAt is set in returned namespace and projection`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `updates metadata with various types`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
