...
class GetEventsServiceTest {
    ...
    @Test
    fun `should get events successfully`() =
        runTest {
    ...
    @Test
    fun `should pass sinceEventId parameter`() =
        runTest {
    ...
    @Test
    fun `should pass limit parameter`() =
        runTest {
            val allEvents = application.getEvents(topicId)
    ...
    @Test
    fun `should get events for different topics`() =
        runTest {
    ...
    @Test
    fun `should return empty list when sinceEventId is last event`() =
        runTest {
            val allEvents = application.getEvents(topicId)
            assertTrue(allEvents.isNotEmpty())
    ...
    @Test
    fun `should combine sinceEventId and limit parameters`() =
        runTest {
            val allEvents = application.getEvents(topicId)
