...
class GetNamespaceServiceTest {
    ...
    @Test
    fun `gets namespace that exists by UUID`() = runTest {
    ...
    @Test
    fun `gets namespace that exists by name`() = runTest {
        val tenant = application.createTenant("acme")
        val tenantId = tenant.tenantId
        val createdNamespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `gets namespace preserves namespaceId after update`() = runTest {
        val tenant = application.createTenant("acme")
        val tenantId = tenant.tenantId
        val createdNamespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `list namespaces filters by tenantId`() = runTest {
