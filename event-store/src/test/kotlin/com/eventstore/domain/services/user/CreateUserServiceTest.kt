...
class CreateUserServiceTest {
    ...
    @Test
    fun `creates user and emits events`() =
        runTest {
            val tenantName = "t-1"
    ...
    @Test
    fun `creates user without primary tenant`() =
        runTest {
            val created =
                application.createUser(
    ...
    @Test
    fun `creates user with metadata`() =
        runTest {
    ...
    @Test
    fun `creates user with suspended status`() =
        runTest {
            val created =
                application.createUser(
    ...
    @Test
    fun `creates user with custom createdBy`() =
        runTest {
            val created =
                application.createUser(
    ...
    @Test
    fun `throws exception when user already exists`() =
        runTest {
            application.createUser(
                email = "alice@example.com",
                name = "Alice",
    ...
    @Test
    fun `throws exception when primary tenant does not exist`() =
        runTest {
