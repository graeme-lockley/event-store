...
class RevokeApiKeyServiceTest {
    ...
    @Test
    fun `revokes API key successfully`() = runTest {
    ...
    @Test
    fun `throws exception when API key does not exist`() = runTest {
    ...
    @Test
    fun `throws exception when API key already revoked`() = runTest {
        val user = application.createUser(
    ...
    @Test
    fun `revoked API key is still in list but marked as inactive`() = runTest {
        val user = application.createUser(
