...
class UpdateTenantServiceTest {
    ...
    @Test
    fun `updates tenant and emits event`() =
        runTest {
    ...
    @Test
    fun `tenant name must be unique`() =
        runTest {
    ...
    @Test
    fun `updates tenant metadata only`() =
        runTest {
    ...
    @Test
    fun `updates all fields together`() =
        runTest {
    ...
    @Test
    fun `preserves existing values when fields are null`() =
        runTest {
            val originalQuota =
                Quota(
                    maxTopics = 10,
    ...
    @Test
    fun `uses default updatedBy when not specified`() =
        runTest {
    ...
    @Test
    fun `uses custom updatedBy when specified`() =
        runTest {
    ...
    @Test
    fun `event payload omits optional fields when null`() =
        runTest {
    ...
    @Test
    fun `event payload matches TenantUpdatedEvent structure`() =
        runTest {
    ...
    @Test
    fun `updatedAt is set in returned tenant and projection`() =
        runTest {
    ...
    @Test
    fun `throws when attempting to update deleted tenant`() =
        runTest {
    ...
    @Test
    fun `throws when updating tenant name to invalid format`() =
        runTest {
    ...
    @Test
    fun `allows updating tenant name with valid formats`() =
        runTest {
            val tenant = application.createTenant("original-name")
    ...
    @Test
    fun `throws when reducing quota below current topics usage`() =
        runTest {
    ...
    @Test
    fun `throws when reducing quota below current namespaces usage`() =
        runTest {
    ...
    @Test
    fun `throws when reducing quota below current consumers usage`() =
        runTest {
    ...
    @Test
    fun `throws when reducing quota below current users usage`() =
        runTest {
    ...
    @Test
    fun `allows increasing quota even when current usage is high`() =
        runTest {
    ...
    @Test
    fun `allows quota reduction when current usage is within new limit`() =
        runTest {
            val tenant = application.createTenant("quota-test", quota = Quota(maxTopics = 10))
    ...
    @Test
    fun `allows partial quota updates without violating usage`() =
        runTest {
