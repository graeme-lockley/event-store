...
class CreateTopicServiceTest {
    ...
    @Test
    fun `should create topic successfully`() =
        runTest {
    ...
    @Test
    fun `should create topics with different topicIds`() =
        runTest {
            val name1 = "topic1"
            val name2 = "topic2"
    ...
    @Test
    fun `should handle multiple schemas`() =
        runTest {
            val name = "new-$topicName"
            val schemas =
                listOf(
    ...
    @Test
    fun `should throw exception when duplicate event types in schemas`() =
        runTest {
            val name = "new-$topicName"
            val schemas =
                listOf(
    ...
    @Test
    fun `should create topic in specific namespace`() =
        runTest {
            val tenantName = "acme"
    ...
    @Test
    fun `should throw exception when namespace does not exist`() =
        runTest {
    ...
    @Test
    fun `should throw exception when schemas list is empty`() =
        runTest {
