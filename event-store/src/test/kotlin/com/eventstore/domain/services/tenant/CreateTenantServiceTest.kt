...
class CreateTenantServiceTest {
    ...
    @Test
    fun `creates tenant and emits event`() =
        runTest {
    ...
    @Test
    fun `throws when tenant already exists`() =
        runTest {
    ...
    @Test
    fun `creates tenant without quota`() =
        runTest {
    ...
    @Test
    fun `creates tenant without metadata`() =
        runTest {
    ...
    @Test
    fun `creates tenant with metadata including complex types`() =
        runTest {
            val metadata =
                mapOf(
                    "string" to "value",
    ...
    @Test
    fun `uses default createdBy when not specified`() =
        runTest {
    ...
    @Test
    fun `uses custom createdBy when specified`() =
        runTest {
    ...
    @Test
    fun `returned tenant object has all fields correctly set`() =
        runTest {
            val quota =
                Quota(
                    maxTopics = 20,
    ...
    @Test
    fun `each tenant gets unique resource ID`() =
        runTest {
    ...
    @Test
    fun `throws when tenant name starts with hyphen`() =
        runTest {
            assertFailsWith<InvalidTenantNameException> {
    ...
    @Test
    fun `throws when tenant name ends with hyphen`() =
        runTest {
            assertFailsWith<InvalidTenantNameException> {
                application.createTenant("invalid-name-")
            }
    ...
    @Test
    fun `throws when tenant name contains special characters`() =
        runTest {
            assertFailsWith<InvalidTenantNameException> {
    ...
    @Test
    fun `throws when tenant name is too short`() =
        runTest {
            assertFailsWith<InvalidTenantNameException> {
    ...
    @Test
    fun `throws when tenant name is too long`() =
        runTest {
    ...
    @Test
    fun `throws when tenant name is reserved system name`() =
        runTest {
            assertFailsWith<InvalidTenantNameException> {
    ...
    @Test
    fun `creates tenant with valid name formats`() =
        runTest {
