...
class ChangePasswordServiceTest {
    ...
    @Test
    fun `changes password and emits event`() = runTest {
        ...
        val result = application.changePassword(
            userId = user.id,
    ...
    @Test
    fun `changes password with custom changedBy`() = runTest {
        val user = application.createUser(
            email = "alice@example.com",
            name = "Alice",
            password = "old-password"
    ...
    @Test
    fun `throws exception when old password is incorrect`() = runTest {
        val user = application.createUser(
            email = "alice@example.com",
            name = "Alice",
