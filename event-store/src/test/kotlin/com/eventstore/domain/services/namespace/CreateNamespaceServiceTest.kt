...
class CreateNamespaceServiceTest {
    ...
    @Test
    fun `creates namespace and emits event`() =
        runTest {
            // Create tenant first
    ...
    @Test
    fun `fails when namespace exists`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `creates namespace with description`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace =
    ...
    @Test
    fun `creates namespace with metadata`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `creates namespace with default name`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `can create multiple namespaces in same tenant`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `can create namespaces in different tenants`() =
        runTest {
    ...
    @Test
    fun `namespace is added to projection`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `fails when tenant quota exceeded with explicit quota`() =
        runTest {
    ...
    @Test
    fun `fails when tenant quota exceeded with default quota`() =
        runTest {
    ...
    @Test
    fun `allows creation when quota not exceeded`() =
        runTest {
    ...
    @Test
    fun `uses explicit quota when tenant has quota set`() =
        runTest {
    ...
    @Test
    fun `quota check happens before name uniqueness check`() =
        runTest {
