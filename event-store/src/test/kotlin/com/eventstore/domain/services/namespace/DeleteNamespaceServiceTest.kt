...
class DeleteNamespaceServiceTest {
    ...
    @Test
    fun `deletes namespace and emits event`() =
        runTest {
    ...
    @Test
    fun `returns false when namespace already deleted`() =
        runTest {
    ...
    @Test
    fun `event payload matches NamespaceDeletedEvent structure`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
            val namespace = application.createNamespace(tenantId, "billing")
    ...
    @Test
    fun `deletes namespace with unicode characters in name`() =
        runTest {
    ...
    @Test
    fun `can delete multiple namespaces sequentially`() =
        runTest {
            val tenant = application.createTenant("acme")
            val tenantId = tenant.tenantId
    ...
    @Test
    fun `can delete namespaces in different tenants`() =
        runTest {
