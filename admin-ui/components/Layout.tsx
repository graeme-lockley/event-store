...
export default function Layout({ children, title = "Event Store Admin", selectedStore }: LayoutProps) {
  return (
    <>
      <Head>
        <title>{title}</title>
        <meta name="description" content="Event Store Administration Dashboard" />
      </Head>
            ...
            <div class="flex justify-between h-16">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <h1 class="text-xl font-bold text-gray-900">Event Store Admin</h1>
                </div>
              </div>
