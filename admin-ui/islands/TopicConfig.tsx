  ...
  const loadConfig = async () => {
    ...
    try {
      const res = await fetch(
        `/api/store-topics?store=${encodeURIComponent(store)}`,
      );
  ...
  return (
    <div class="bg-white shadow rounded-lg">
      <div class="px-6 py-4 border-b border-gray-200">
        ...
        <p class="mt-1 text-sm text-gray-500">
          Schema definitions and topic settings
        </p>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <p class="mt-1 text-lg text-gray-900">
              {data.config.sequence.toLocaleString()}
            </p>
          </div>
        </div>
              ...
              <div class="bg-gray-50 rounded-lg p-4">
                <div class="flex items-center justify-between mb-3">
                  <h5 class="text-sm font-medium text-gray-900">
                    Event Type:{" "}
                    <span class="text-blue-600">{schema.eventType}</span>
                  </h5>
                ...
                <div class="space-y-3">
                  ...
                  {schema.properties &&
                    ...
                    <div>
                      <h6 class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">
                        Properties
                      </h6>
