...
var listCmd = &cobra.Command{
	...
	RunE: func(cobraCmd *cobra.Command, args []string) error {
		...
		users, err := apiClient.ListUsers(tenantID)
		if err != nil {
		...
		case "json":
			return output.PrintUsersListJSON(users)
		case "csv":
			return output.PrintUsersListCSV(users)
		default:
			output.PrintUsersList(users)
			return nil
		}
	},
}
...
func init() {
	cmd.UserCmd().AddCommand(listCmd)
